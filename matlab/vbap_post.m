...
xlabel('X [m]')
ylabel('Y [m]')
legend('Rabbit Posit','USV Posit','Location','southeast')
...
figure(2); clf();
    ...
    ylabel('X Posit [m]')
    grid on
    title('USV and rabbit XY Posit vs Time')
    legend('Rabbit','USV','location','southwest')
